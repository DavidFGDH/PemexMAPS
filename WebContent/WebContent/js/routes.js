  ...
  function initialize(){
	...
	var map = new google.maps.Map(document.getElementById('map-canvas'), my_options);
	    ...
	    var onMarkerMouseOver = function() {
	      ...
	      infoWindow1.setContent('<h3>Mexico City</h3><img src="images/cdmx.jpg" /><br>latitude=' +
	   ...
	   var mkr = new google.maps.Marker({
	    ...
	    var onMarkerMouseOver = function() {
	      var latLng = this.getPosition();
	      infoWindow1.setContent('<h3>Campeche</h3><img src="images/cam.png" /><br>latitude=' +
	          latLng.lat() + ', longitude=' + latLng.lng()+'<br><br><a href="http://en.wikipedia.org/wiki/Mexico_city">link to site</a>');
	      infoWindow1.open(map, this);
	    };
	    google.maps.event.addListener(map, 'mouseout', function() {
	  ...
	  var mkr1 = new google.maps.Marker({
	    ...
	    var onMarkerMouseOver = function() {
	      var latLng = this.getPosition();
	      infoWindow1.setContent('<h3>Tampico</h3><img src="images/tam.png" /><br>latitude=' +
	  ...
	  var mkr1 = new google.maps.Marker({
	    ...
	    var onMarkerMouseOver = function() {
	      var latLng = this.getPosition();
	      infoWindow1.setContent('<h3>Monterrey</h3><img src="images/mty.jpe" /><br>latitude=' +
	  ...
	  var mkr1 = new google.maps.Marker({
	    ...
	    var onMarkerMouseOver = function() {
	      var latLng = this.getPosition();
	      infoWindow1.setContent('<h3>San Luis Potosi</h3><img src="images/slp.jpg" /><br />latitude=' +
	   ...
	   var infoWindow1 = new google.maps.InfoWindow;
	    var onMarkerMouseOver = function() {
	      var latLng = this.getPosition();
	      infoWindow1.setContent('<h3>Campeche</h3><img src="images/mty.jpg" /><br>latitude=' +
	          latLng.lat() + ', longitude=' + latLng.lng()+'<br><br><a href="http://en.wikipedia.org/wiki/Mexico_city">link to site</a>');
	      infoWindow1.open(map, this);
	    };
	    google.maps.event.addListener(map, 'mouseout', function() {
	   ...
	   var infoWindow1 = new google.maps.InfoWindow;
	    var onMarkerMouseOver = function() {
	      var latLng = this.getPosition();
	      infoWindow1.setContent('<h3>Tula</h3><img src="images/th.jpg" /><br>latitude=' +
	          latLng.lat() + ', longitude=' + latLng.lng()+'<br><br><a href="http://en.wikipedia.org/wiki/Mexico_city">link to site</a>');
	      infoWindow1.open(map, this);
	    };
	    google.maps.event.addListener(map, 'mouseout', function() {
	   ...
	   var infoWindow1 = new google.maps.InfoWindow;
	    var onMarkerMouseOver = function() {
	      var latLng = this.getPosition();
	      infoWindow1.setContent('<h3>Cadereyta</h3><img src="images/cdmx.jpg" /><br>latitude=' +
	          latLng.lat() + ', longitude=' + latLng.lng()+'<br><br><a href="http://en.wikipedia.org/wiki/Mexico_city">link to site</a>');
	      infoWindow1.open(map, this);
	    };
	    google.maps.event.addListener(map, 'mouseout', function() {
	   ...
	   var infoWindow1 = new google.maps.InfoWindow;
	    var onMarkerMouseOver = function() {
	      var latLng = this.getPosition();
	      infoWindow1.setContent('<h3>Salamanca</h3><img src="images/salgto.jpg" /><br />latitude=' +
	          latLng.lat() + ', longitude=' + latLng.lng()+'<br><br><a href="https://en.wikipedia.org/wiki/San_Luis_Potos%C3%AD_City">link to site</a>');
	      infoWindow1.open(map, this);
	    };
	    google.maps.event.addListener(map, 'mouseout', function() {
	   ...
	   var marksg = new google.maps.Marker({
	    ...
	    var onMarkerMouseOver = function() {
	      var latLng = this.getPosition();
	      infoWindow1.setContent('<h3>Tabasco</h3><img src="images/tab.jpg" /><br />latitude=' +
	          latLng.lat() + ', longitude=' + latLng.lng()+'<br><br><a href="https://en.wikipedia.org/wiki/San_Luis_Potos%C3%AD_City">link to site</a>');
	      infoWindow1.open(map, this);
	    };
	    google.maps.event.addListener(map, 'mouseout', function() {
